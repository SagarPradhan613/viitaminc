...
const RewardToken = () => {
    return (
        ...
        <div className='border-[3px] border-[#E5C757] contract-main flex flex-col justify-center align-middle items-center py'>
            <div className='contract-content flex flex-col justify-center items-center align-middle'>
                ...
                <div className='absolute left-0 top-0 opacity-50 '>
                    <img src='Images/topleftreward.png' className='w-1/4 lg:w-full'></img>
                </div>
                <div className='lg:flex '>
                    <div className='lg:w-[60%] py-5 lg:px-20 px-10 mt-10 lg:mt-0 lg:mb-20 mb-16'>
                    ...
                    <div className='lg:w-[40%] relative'>
                        <div className='absolute right-0 bottom-0 opacity-70'>
                            <img src='Images/righttrophy.png' className='lg:block hidden'></img>
                        </div>
                        <img src='Images/rewardbg.png' className='lg:w-2/3 w-1/4 absolute right-0 bottom-0 opacity-70' alt='Reward Background' />
